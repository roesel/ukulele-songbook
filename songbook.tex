...
\begin{document}
	...
	%\clearpage
	\input{preprocessing/tex/how-to-save-a-life.txt.tex}
	\clearpage
	\input{preprocessing/tex/bedna-od-whisky.txt.tex}
	\clearpage
	\input{preprocessing/tex/batalion.txt.tex}
	\clearpage
	\input{preprocessing/tex/whats-up.txt.tex}
	\clearpage
	\input{preprocessing/tex/stand-by-me.txt.tex}
	\clearpage
	\input{preprocessing/tex/slavici-z-madridu.txt.tex}
\end{document}